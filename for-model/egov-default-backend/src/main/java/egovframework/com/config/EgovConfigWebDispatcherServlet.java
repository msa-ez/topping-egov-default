...
public class EgovConfigWebDispatcherServlet implements WebMvcConfigurer {
	 ...
	 * RESOLVER_DEFAULT_ERROR_VIEW);
	 * 
	 * Properties mappings = new Properties();
	 * mappings.setProperty("org.springframework.dao.DataAccessException",
	 * "cmm/error/dataAccessFailure");
	 * mappings.setProperty("org.springframework.transaction.TransactionException",
	 * "cmm/error/transactionFailure");
	 * mappings.setProperty("org.egovframe.rte.fdl.cmmn.exception.EgovBizException",
	 * "cmm/error/egovError");
	 * mappings.setProperty("org.springframework.security.AccessDeniedException",
